/*****************************************************************************
* Filename:          E:\uni\4\SE\Practica5/drivers/my_multiple_periferic_v1_00_a/src/my_multiple_periferic_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_multiple_periferic driver
...
XStatus MY_MULTIPLE_PERIFERIC_SelfTest(void * baseaddr_p)
{
  ...
  MY_MULTIPLE_PERIFERIC_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MY_MULTIPLE_PERIFERIC_mReadSlaveReg0(baseaddr, 0);
  ...
  MY_MULTIPLE_PERIFERIC_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MY_MULTIPLE_PERIFERIC_mReadSlaveReg1(baseaddr, 0);
  ...
  MY_MULTIPLE_PERIFERIC_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MY_MULTIPLE_PERIFERIC_mReadSlaveReg2(baseaddr, 0);
  ...
  MY_MULTIPLE_PERIFERIC_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MY_MULTIPLE_PERIFERIC_mReadSlaveReg3(baseaddr, 0);
